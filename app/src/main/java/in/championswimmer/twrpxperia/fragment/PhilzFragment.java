 ...
 * {@link in.championswimmer.twrpxperia.fragment.PhilzFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link in.championswimmer.twrpxperia.fragment.PhilzFragment#newInstance} factory method to
 * create an instance of this in.championswimmer.twrpxperia.fragment.
 */
public class PhilzFragment extends Fragment {
     ...
     * @return A new instance of in.championswimmer.twrpxperia.fragment PhilzFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PhilzFragment newInstance(String param1, String param2) {
        PhilzFragment fragment = new PhilzFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dir = new SaveDir();
        philzExists = dir.existsPhilzImage();
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_philz, container, false);
        final Button downloadButton = (Button) rootView.findViewById(R.id.philz_download_button);
        Button flashButton = (Button) rootView.findViewById(R.id.philz_flash_button);

        //enable flash only if philz.img exists
        flashButton.setEnabled((philzExists) && (hasRoot));

        flashButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (dir.validPhilz()) {
                    ff.flashimg(dir.RAW_PHILZ_PATH);
                } else {
                    AlertDialog.Builder ad = new AlertDialog.Builder(inflater.getContext());
                    ad.setTitle("WARNING");
                    ad.setMessage(getResources().getString(R.string.alert_invalid_philz_image));
